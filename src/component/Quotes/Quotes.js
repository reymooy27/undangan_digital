...
export default function Quotes() {
  return (
    <div className="h-screen p-12 bg-green">
        <motion.h3 whileInView={{opacity: 1}} transition={{ease: 'easeInOut', duration: 3}} initial={{opacity: 0}} viewport={{once: true}} className="text-center text-white">Dan nikahkanlah orang-orang yang sendirian di antara kamu, 
