    ...
    <div className="flex flex-col items-center pt-12">
      ...
      <motion.div layout whileInView={{opacity: 1, translateY: 0}} initial={{opacity: 0, translateY: 50}} transition={{ease: 'easeInOut',duration: 1}} viewport={{once: true}} className="w-full flex flex-col xl:flex-row items-center justify-evenly pb-10">
        <div className="rounded-full w-36 h-36">
          <img className="w-full object-contain rounded-full" src="/laki.png" alt="" />
        </div>
        <div className="text-center">
          <h3 className="font-title text-5xl text-green">Amaludin Asisah Abinah</h3>
      ...
      <motion.div layout whileInView={{opacity: 1, translateY: 0}} initial={{opacity: 0, translateY: 50}} transition={{ease: 'easeInOut',duration: 1}} viewport={{once: true}} 
      className="w-full flex flex-col xl:flex-row items-center justify-evenly pt-10">
        ...
        <div className="flex flex-col rounded-full w-36 h-36 order-1 xl:order-2">
          <img className="w-full object-contain rounded-full" src="/perempuan.png" alt="" />
        </div>
      </motion.div>
    </div>
  )
